...
public class GroupReadRecordFiler : BaseFiller<GroupMemberReadRecordModel>
{
    ...
    protected override void OnGetListItem(int index, int itemType, GameObject obj)
    {
        ...
        obj.GetComponent<GroupReadRecordCell>().InitUi(index,DataSource[index], (clickIndex, model) =>
        {
            if (OnCellClick != null)
